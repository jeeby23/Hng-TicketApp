  ...
  >
    ...
    >
      <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-2">Join Tixkect</h1>
      ...
      <form @submit.prevent="handleSignup" class="space-y-6">
        ...
        <button
          type="submit"
          class="w-full bg-blue-500 text-white font-semibold rounded-xl py-3 hover:bg-blue-600 transition duration-300 shadow-md"
        >
          Sign Up
        </button>
        ...
        <p class="text-sm text-gray-700 mt-6 text-center">
          ...
          <router-link :to="{ name: 'Login' }" class="text-blue-500 font-semibold hover:underline">
            Log In
          </router-link>
        </p>
      </form>
